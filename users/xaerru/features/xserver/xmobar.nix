  ...
  programs.xmobar = {
    ...
    Config { font    = "Source Code Pro 10px"
           ...
           , commands = [ Run Date "%a %B %e %H:%M" "date" 50
                        , Run Network "wlp130s0f0" ["-t", "<fn=2>\xf019</fn> <rx>kb <fn=2>\xf093</fn> <tx>kb"] 20
           ...
           , sepChar = "%"
           , alignSep = "}{"
           , template = " <icon=profile.xpm/> <fc=#${colors.base04}>|</fc> %UnsafeStdinReader% }{ <fc=#${colors.base0B}>%music%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base08}>%jeeadv%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0C}>%uname%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0B}>%disku%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0E}>Vol: %sound%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0D}>%memory%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0E}>%cpu%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0D}>%wlp130s0f0%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base0B}>%battery%</fc> <fc=#${colors.base04}>|</fc> <fc=#${colors.base07}>%date%</fc> %trayerpad%"
    '';
  };
}
